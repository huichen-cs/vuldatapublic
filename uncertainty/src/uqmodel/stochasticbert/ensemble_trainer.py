...
class BertTrainer(object):
    ...
    def _log_tb_training_summary(self, epoch:int, train_loss:float, val_loss:float, lr:float):
    ...
    def fit(self):
        ...
        for epoch in range(self.max_iter):
            ...
            logger.info(
                'epoch: {}, learning_rate: {}, total_train_loss: {} total_val_loss: {}'
                .format(epoch,
            ...
            if self.checkpoint and self.checkpoint.min_loss_updated(epoch, total_val_loss):
        ...
        print('Model {}: CUDA memory allocation {} -> {}'.format(self.model_idx, old_usage, new_usage))
        return self.model
...
class EnsembleTrainer(object):
    ...
    def fit(self):
        ...
        self.checkpoint.save_ensemble_meta(0, self.model_size, total_loss, min_total_loss)
    ...
    def load_checkpoint(self):
        ...
        for model_idx,model in enumerate(self.ensemble_classifier):
            ...
            (model, optimizer, lr_scheduler, criteria, loss, min_member_loss) = (
