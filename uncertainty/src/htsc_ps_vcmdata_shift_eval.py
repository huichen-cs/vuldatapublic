...
from uqmodel.ensemble.eval_utils import load_from_checkpoint_with_datashift, compute_uq_eval_metrics, result_dict_to_json
...
if __name__ == '__main__':
    ...
    train_dataloader, val_dataloader, test_dataloader, ensemble = load_from_checkpoint_with_datashift('disentangle', config, device=device)
