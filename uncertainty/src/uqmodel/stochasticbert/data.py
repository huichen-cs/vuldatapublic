...
logger = logging.getLogger('bert_data')
        ...
        if self.config.trainer_use_model == 'use_checkpoint':
            try:
                ...
                logger.info('loaded train/val/test datasets from checkpoint at {}'
                            .format(self.config.trainer_checkpoint_dir_path))
            ...
            raise ValueError('unsupported configuration option {} for config.trainer_use_model'
                             .format(self.config.trainer_use_model))
