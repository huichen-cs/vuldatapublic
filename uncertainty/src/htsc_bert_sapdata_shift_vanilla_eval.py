...
from uqmodel.shiftstochasticbert.vanilla_eval_utils import (
    StochasticVanillaBertClassifierEvalautor,
)
from uqmodel.shiftstochasticbert.stochastic_vanilla_bert import (
    StochasticVanillaBertClassifier,
)
...
def main():
    ...
    datasets = BertExperimentDatasets(config, tag=None, dataset_name="SAPDATA")
    ...
    dropout_model = StochasticVanillaBertClassifier(
    ...
    evaluator = StochasticVanillaBertClassifierEvalautor(
