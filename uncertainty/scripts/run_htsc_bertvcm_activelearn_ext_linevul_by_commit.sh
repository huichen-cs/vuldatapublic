...
linevul_input_file="data/linevul/linevul_train_vul.csv"
linevul_output_file="output/linevul/commit/linevul_train_vul_${method}_${model}_${ratio}_${runid}.pth"

if [[ $# -ge 6 ]]; then
  linevul_input_file=$6
  base_fn=$(basename ${linevul_input_file})
  base_fn=${base_fn/.csv/}
  linevul_output_file="output/linevul/commit/${base_fn}_${method}_${model}_${ratio}_${runid}.pth"
fi
